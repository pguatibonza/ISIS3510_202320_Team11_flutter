...
class _CurrentTripState extends State<CurrentTrip> {
  ...
  Trailer? trailer;
  late Trip tripsito;
  late AccessPoint pickup;
  late AccessPoint dropoff;
  late Load load;
  ...
  Future<void> fetchTripDetails() async {
    ...
    final loadResponse = await http.get(Uri.parse('$loads/${tripsito.load}'));
              ...
              child: Column(
                ...
                children: [
                  Text('Load Type: ${load.type}',
                    ...
                    Text('Trailer Type: ${load.trailerType}',
                        style: GoogleFonts.montserrat(
                            fontSize: 14 * ffem,
                            fontWeight: FontWeight.w600,
                            height: 1.2000000477 * ffem / fem,
